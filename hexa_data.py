...
ENRIQUECIMENTOS_EXTERNOS: dict[str, dict[str, Any]] = {'Antony': {'nome': 'Antony',
 ...
 'Éderson': {'nome': 'Éderson',
             ...
             'tm_fonte': 'Imagem fornecida pelo usuário',
             'tm_extraido_em': '17/07/2026',
             'tm_clube_desde': '06/07/2022',
             'tm_contrato': '30/06/2031',
             'tm_ultima_renovacao': '17/07/2026'},
 ...
 'Kevin': {'nome': 'Kevin',
           ...
           'tm_fonte': 'Imagem fornecida pelo usuário',
           'tm_extraido_em': '17/07/2026'},
 'William Gomes': {'nome_completo': 'William Gomes Carvalho Santos',
                   'clube': 'FC Porto',
                   'idade': 20,
 ...
 'Kauã Elias': {'nome_completo': 'Kauã Elias Nogueira',
                ...
                'tm_fonte': 'Imagem fornecida pelo usuário',
                'tm_extraido_em': '17/07/2026'},
 'Lucas Perri': {'nome_completo': 'Lucas Estella Perri',
                 'clube': 'Leeds United FC',
                 'idade': 28,
                 'tm_nascimento': '10/12/1997',
                 'tm_naturalidade': 'Valinhos, Brasil',
                 'tm_altura': '1,97 m',
                 'tm_nacionalidades': ['Brasil', 'Itália'],
                 'tm_pe': 'Direito',
                 'tm_empresario': 'LEFT Sports',
                 'tm_clube_desde': '26/07/2025',
                 'tm_contrato': '30/06/2029',
                 'tm_equipador': 'adidas',
                 'tm_posicao_site': 'Guarda-redes',
                 'tm_posicoes_secundarias_site': [],
                 ...
                 'tm_fonte': 'Imagem fornecida pelo usuário',
                 'tm_extraido_em': '17/07/2026'},
 'Wesley França': {'nome_completo': 'Wesley Vinícius França Lima',
                   'clube': 'AS Roma',
                   'idade': 22,
                   'tm_nascimento': '06/09/2003',
                   'tm_naturalidade': 'Açailândia, Brasil',
                   'tm_altura': '1,78 m',
                   'tm_nacionalidades': ['Brasil'],
                   'tm_pe': 'Direito',
                   'tm_empresario': 'MCL Agency',
                   'tm_clube_desde': '28/07/2025',
                   'tm_contrato': '30/06/2030',
                   'tm_equipador': 'Nike',
                   'tm_posicao_site': 'Lateral Direito',
                   'tm_posicoes_secundarias_site': ['Médio Direito', 'Médio Esquerdo'],
                   'tm_valor_mercado': '40,00 M. €',
                   'tm_valor_mercado_milhoes': 40.0,
                   'tm_valor_maximo': '40,00 M. €',
                   'tm_valor_maximo_milhoes': 40.0,
                   'tm_data_valor_maximo': '23/03/2026',
                   'tm_ultima_atualizacao': '28/05/2026',
                   'tm_fonte': 'Imagem fornecida pelo usuário',
                   'tm_extraido_em': '17/07/2026'},
 'Kaiki Bruno': {'nome_completo': 'Kaiki Bruno da Silva',
                 'clube': 'Como 1907',
                 'idade': 23,
                 'tm_nascimento': '08/03/2003',
                 'tm_naturalidade': 'Betim, Brasil',
                 'tm_altura': '1,72 m',
                 'tm_nacionalidades': ['Brasil'],
                 'tm_pe': 'Esquerdo',
                 'tm_empresario': 'CAA Stellar',
                 'tm_clube_desde': '02/07/2026',
                 'tm_contrato': '30/06/2027',
                 'tm_opcao_contrato': 'Compra obrigatória com condições',
                 'tm_emprestado_de': 'Cruzeiro EC',
                 'tm_contrato_clube_origem': '31/12/2027',
                 'tm_equipador': 'adidas',
                 'tm_posicao_site': 'Lateral Esquerdo',
                 'tm_posicoes_secundarias_site': [],
                 'tm_valor_mercado': '14,00 M. €',
                 ...
                 'tm_fonte': 'Imagem fornecida pelo usuário',
                 'tm_extraido_em': '17/07/2026'},
 'Yan Couto': {'nome_completo': 'Yan Bueno Couto',
               'clube': 'Borussia Dortmund',
               'idade': 24,
               'tm_nascimento': '03/06/2002',
               'tm_naturalidade': 'Curitiba, Brasil',
               'tm_altura': '1,68 m',
               'tm_nacionalidades': ['Brasil', 'Portugal'],
               'tm_pe': 'Direito',
               'tm_empresario': 'CAA Stellar',
               'tm_clube_desde': '01/07/2025',
               'tm_contrato': '30/06/2030',
               'tm_posicao_site': 'Lateral Direito',
               'tm_posicoes_secundarias_site': ['Médio Direito'],
               'tm_valor_mercado': '17,00 M. €',
               'tm_valor_mercado_milhoes': 17.0,
               'tm_valor_maximo': '25,00 M. €',
               'tm_valor_maximo_milhoes': 25.0,
               'tm_data_valor_maximo': '06/06/2024',
               'tm_ultima_atualizacao': '26/05/2026',
               'tm_fonte': 'Imagem fornecida pelo usuário',
               'tm_extraido_em': '17/07/2026'},
 'Denner': {'nome_completo': 'Denner Alves Evangelista Pereira',
            'clube': 'Chelsea FC',
            'idade': 18,
            'tm_nascimento': '25/02/2008',
            'tm_altura': '1,75 m',
            'tm_nacionalidades': ['Brasil'],
            'tm_pe': 'Esquerdo',
            'tm_clube_desde': '01/07/2026',
            'tm_contrato': '30/06/2032',
            'tm_equipador': 'adidas',
            'tm_posicao_site': 'Lateral Esquerdo',
            'tm_posicoes_secundarias_site': [],
            'tm_observacao': 'Primo de Gabriel Magalhães (FC Arsenal).',
            'tm_valor_transferencia': '10,00 M. €',
            'tm_fonte': 'Imagem fornecida pelo usuário',
            'tm_extraido_em': '17/07/2026'},
 'Gabriel Magalhães': {'nome_completo': 'Gabriel dos Santos Magalhães',
                       'clube': 'FC Arsenal',
                       'idade': 28,
                       'tm_nascimento': '19/12/1997',
                       'tm_naturalidade': 'São Paulo, Brasil',
                       'tm_altura': '1,90 m',
                       'tm_nacionalidades': ['Brasil'],
                       'tm_pe': 'Esquerdo',
                       'tm_empresario': 'Bertolucci Sports',
                       'tm_clube_desde': '01/09/2020',
                       'tm_contrato': '30/06/2029',
                       'tm_ultima_renovacao': '06/06/2025',
                       'tm_posicao_site': 'Defesa Central',
                       'tm_posicoes_secundarias_site': [],
                       'tm_valor_mercado': '75,00 M. €',
                       'tm_valor_mercado_milhoes': 75.0,
                       'tm_valor_maximo': '75,00 M. €',
                       'tm_valor_maximo_milhoes': 75.0,
                       'tm_data_valor_maximo': '30/09/2024',
                       'tm_ultima_atualizacao': '02/06/2026',
                       'tm_fonte': 'Imagem fornecida pelo usuário',
                       'tm_extraido_em': '17/07/2026'},
 'Rodrygo': {'nome_completo': 'Rodrygo Silva de Goes',
             'clube': 'Real Madrid CF',
             'idade': 25,
             'tm_nascimento': '09/01/2001',
             'tm_naturalidade': 'Osasco, Brasil',
             'tm_altura': '1,74 m',
             'tm_nacionalidades': ['Brasil', 'Espanha'],
             'tm_pe': 'Direito',
             'tm_empresario': 'Familiar',
             'tm_clube_desde': '01/07/2019',
             'tm_contrato': '30/06/2028',
             'tm_ultima_renovacao': '02/11/2023',
             'tm_equipador': 'adidas',
             'tm_posicao_site': 'Extremo Direito',
             'tm_posicoes_secundarias_site': ['Extremo Esquerdo', 'Ponta de Lança'],
             'tm_valor_mercado': '45,00 M. €',
             'tm_valor_mercado_milhoes': 45.0,
             'tm_valor_maximo': '110,00 M. €',
             'tm_valor_maximo_milhoes': 110.0,
             'tm_data_valor_maximo': '06/06/2024',
             'tm_ultima_atualizacao': '04/06/2026',
             'tm_fonte': 'Imagem fornecida pelo usuário',
             'tm_extraido_em': '17/07/2026'},
 'Gabriel Mec': {'nome_completo': 'Gabriel Ferreira de Carvalho',
                 'clube': 'Grêmio FBPA',
                 'idade': 18,
                 'tm_nascimento': '11/04/2008',
                 'tm_naturalidade': 'Campos dos Goytacazes, Brasil',
                 'tm_altura': '1,73 m',
                 'tm_nacionalidades': ['Brasil'],
                 'tm_pe': 'Ambos',
                 'tm_empresario': 'Hub Agent Sports',
                 'tm_clube_desde': '28/01/2025',
                 'tm_contrato': '30/06/2027',
                 'tm_posicao_site': 'Médio Ofensivo',
                 'tm_posicoes_secundarias_site': ['Extremo Esquerdo', 'Extremo Direito'],
                 'tm_valor_mercado': '16,00 M. €',
                 'tm_valor_mercado_milhoes': 16.0,
                 'tm_valor_maximo': '16,00 M. €',
                 'tm_valor_maximo_milhoes': 16.0,
                 ...
                 'tm_fonte': 'Imagem fornecida pelo usuário',
                 'tm_extraido_em': '17/07/2026'},
 'Luiz Henrique': {'nome': 'Luiz Henrique',
                   'nome_completo': 'Luiz Henrique André Rosa da Silva',
                   'posicao': 'Ponta-direita',
                   'posicoes_multiplas': ['Ponta-direita', 'Ponta-esquerda', 'Centroavante'],
                   ...
                   'pontos_fracos': '',
                   'historico': '',
                   'tm_nascimento': '02/01/2001',
                   'tm_naturalidade': 'Petrópolis, Brasil',
                   'tm_altura': '1,82 m',
                   'tm_nacionalidades': ['Brasil'],
                   'tm_pe': 'Esquerdo',
                   'tm_empresario': 'REASON FOOTBALL',
                   'tm_clube_desde': '20/01/2025',
                   'tm_contrato': '31/12/2028',
                   'tm_opcao_contrato': 'Mais um ano',
                   'tm_equipador': 'adidas',
                   'tm_posicao_site': 'Extremo Direito',
                   'tm_posicoes_secundarias_site': ['Extremo Esquerdo', 'Ponta de Lança'],
                   'tm_valor_mercado': '24,00 M. €',
                   'tm_valor_mercado_milhoes': 24.0,
                   'tm_valor_maximo': '25,00 M. €',
                   'tm_valor_maximo_milhoes': 25.0,
                   'tm_data_valor_maximo': '18/03/2025',
                   'tm_ultima_atualizacao': '25/05/2026',
                   'tm_fonte': 'Imagem fornecida pelo usuário',
                   'tm_extraido_em': '17/07/2026'},
 'Vitor Roque': {'nome': 'Vitor Roque',
                 'nome_completo': 'Vitor Hugo Roque Ferreira',
                 'posicao': 'Centroavante',
                 'posicoes_multiplas': ['Centroavante', 'Segundo atacante', 'Ponta-esquerda'],
                 'clube': 'SE Palmeiras',
                 'idade': 21,
                 'grupo': 'Observação',
                 'tipo': 'Observação',
                 ...
                 'pontos_fracos': '',
                 'historico': '',
                 'tm_nascimento': '28/02/2005',
                 'tm_naturalidade': 'Timóteo, Brasil',
                 'tm_altura': '1,74 m',
                 'tm_nacionalidades': ['Brasil'],
                 'tm_pe': 'Direito',
                 'tm_empresario': 'LINK SPORTS',
                 'tm_clube_desde': '28/02/2025',
                 'tm_contrato': '31/12/2029',
                 'tm_equipador': 'Nike',
                 'tm_posicao_site': 'Ponta de Lança',
                 'tm_posicoes_secundarias_site': ['Segundo Avançado', 'Extremo Esquerdo'],
                 'tm_valor_mercado': '38,00 M. €',
                 'tm_valor_mercado_milhoes': 38.0,
                 'tm_valor_maximo': '40,00 M. €',
                 'tm_valor_maximo_milhoes': 40.0,
                 'tm_data_valor_maximo': '10/12/2023',
                 'tm_ultima_atualizacao': '25/05/2026',
                 'tm_fonte': 'Imagem fornecida pelo usuário',
                 'tm_extraido_em': '17/07/2026'},
 'Gabriel Moscardo': {'nome': 'Gabriel Moscardo',
                      'nome_completo': 'Gabriel Silva Moscardo de Salles',
                      'posicao': 'Volante',
                      ...
                      'pontos_fracos': '',
                      'historico': '',
                      'tm_nascimento': '28/09/2005',
                      'tm_naturalidade': 'Taubaté, Brasil',
                      'tm_altura': '1,85 m',
                      'tm_nacionalidades': ['Brasil'],
                      'tm_pe': 'Direito',
                      'tm_empresario': 'SportsMaxi',
                      'tm_clube_desde': '08/07/2026',
                      'tm_contrato': '30/06/2027',
                      'tm_emprestado_de': 'FC Paris Saint-Germain',
                      'tm_contrato_clube_origem': '30/06/2028',
                      'tm_equipador': 'adidas',
                      'tm_posicao_site': 'Médio Defensivo',
                      'tm_posicoes_secundarias_site': [],
                      'tm_valor_mercado': '7,00 M. €',
                      ...
                      'tm_fonte': 'Imagem fornecida pelo usuário',
                      'tm_extraido_em': '17/07/2026'},
 'Roger Ibañez': {'nome': 'Roger Ibañez',
                  'nome_completo': 'Roger Ibañez da Silva',
                  'posicao': 'Zagueiro',
                  'posicoes_multiplas': ['Zagueiro', 'Lateral-direito'],
                  'clube': 'Al-Ahli SFC',
                  'idade': 27,
                  ...
                  'pontos_fracos': '',
                  'historico': '',
                  'tm_nascimento': '23/11/1998',
                  'tm_naturalidade': 'Canela, Brasil',
                  'tm_altura': '1,86 m',
                  'tm_nacionalidades': ['Brasil', 'Itália'],
                  'tm_pe': 'Direito',
                  'tm_empresario': 'Promanager',
                  'tm_clube_desde': '10/08/2023',
                  'tm_contrato': '30/06/2027',
                  'tm_posicao_site': 'Defesa Central',
                  'tm_posicoes_secundarias_site': ['Lateral Direito'],
                  'tm_valor_mercado': '18,00 M. €',
                  ...
                  'tm_valor_maximo': '30,00 M. €',
                  'tm_valor_maximo_milhoes': 30.0,
                  'tm_data_valor_maximo': '20/03/2023',
                  'tm_ultima_atualizacao': '03/06/2026',
                  'tm_fonte': 'Imagem fornecida pelo usuário',
                  'tm_extraido_em': '17/07/2026'},
 'Lucca Meirelles': {'nome': 'Lucca Meirelles',
                     'nome_completo': 'Lucca Oliveira Meirelles',
                     'posicao': 'Centroavante',
                     'posicoes_multiplas': ['Centroavante', 'Ponta-esquerda'],
                     'clube': 'Shakhtar Donetsk',
                     'idade': 19,
                     'grupo': 'Observação',
                     'tipo': 'Promessa 2030',
                     ...
                     'pontos_fracos': '',
                     'historico': '',
                     'tm_nascimento': '15/03/2007',
                     'tm_naturalidade': 'Goiânia, Brasil',
                     'tm_altura': '1,85 m',
                     'tm_nacionalidades': ['Brasil'],
                     'tm_pe': 'Direito',
                     'tm_empresario': 'Bertolucci Sports',
                     'tm_clube_desde': '28/08/2025',
                     'tm_contrato': '30/06/2030',
                     'tm_posicao_site': 'Ponta de Lança',
                     'tm_posicoes_secundarias_site': ['Extremo Esquerdo'],
                     'tm_valor_mercado': '10,00 M. €',
                     ...
                     'tm_fonte': 'Imagem fornecida pelo usuário',
                     'tm_extraido_em': '17/07/2026'},
 'Estevão': {'nome_completo': 'Estêvão Willian Almeida de Oliveira Gonçalves',
             'clube': 'Chelsea FC',
             'idade': 19,
             'tm_nascimento': '24/04/2007',
             'tm_naturalidade': 'Franca, Brasil',
             'tm_altura': '1,78 m',
             'tm_nacionalidades': ['Brasil'],
             'tm_pe': 'Esquerdo',
             'tm_empresario': 'LINK SPORTS',
             'tm_clube_desde': '14/07/2025',
             'tm_contrato': '30/06/2033',
             'tm_equipador': 'Nike',
             'tm_posicao_site': 'Extremo Direito',
             'tm_posicoes_secundarias_site': ['Médio Ofensivo', 'Médio Direito'],
             ...
             'tm_valor_maximo': '80,00 M. €',
             'tm_valor_maximo_milhoes': 80.0,
             'tm_data_valor_maximo': '08/12/2025',
             'tm_ultima_atualizacao': '02/06/2026',
             'tm_fonte': 'Imagem fornecida pelo usuário',
             'tm_extraido_em': '17/07/2026'},
 'Gabriel Martinelli': {'nome_completo': 'Gabriel Teodoro Martinelli Silva',
                        'clube': 'FC Arsenal',
                        'idade': 25,
                        'tm_nascimento': '18/06/2001',
                        'tm_naturalidade': 'Guarulhos, Brasil',
                        'tm_altura': '1,78 m',
                        'tm_nacionalidades': ['Brasil', 'Itália'],
                        'tm_pe': 'Direito',
                        'tm_empresario': 'Roc Nation Sports',
                        'tm_clube_desde': '02/07/2019',
                        'tm_contrato': '30/06/2027',
                        'tm_opcao_contrato': 'Mais um ano',
                        'tm_ultima_renovacao': '03/02/2023',
                        'tm_equipador': 'adidas',
                        'tm_posicao_site': 'Extremo Esquerdo',
                        'tm_posicoes_secundarias_site': ['Extremo Direito'],
                        'tm_valor_mercado': '45,00 M. €',
                        'tm_valor_mercado_milhoes': 45.0,
                        'tm_valor_maximo': '85,00 M. €',
                        'tm_valor_maximo_milhoes': 85.0,
                        'tm_data_valor_maximo': '18/12/2023',
                        'tm_ultima_atualizacao': '02/06/2026',
                        'tm_fonte': 'Imagem fornecida pelo usuário',
                        'tm_extraido_em': '17/07/2026'},
 'João Gomes': {'nome_completo': 'João Victor Gomes da Silva',
                'clube': 'Wolverhampton Wanderers',
                'idade': 25,
                'tm_nascimento': '12/02/2001',
                'tm_naturalidade': 'Rio de Janeiro, Brasil',
                'tm_altura': '1,76 m',
                'tm_nacionalidades': ['Brasil'],
                'tm_pe': 'Direito',
                'tm_empresario': 'Carlos Leite',
                'tm_clube_desde': '30/01/2023',
                'tm_contrato': '30/06/2030',
                'tm_opcao_contrato': 'Opção do clube por 1 ano',
                'tm_ultima_renovacao': '01/04/2025',
                'tm_equipador': 'Nike',
                'tm_posicao_site': 'Médio Centro',
                'tm_posicoes_secundarias_site': ['Médio Defensivo'],
                'tm_valor_mercado': '40,00 M. €',
                ...
                'tm_fonte': 'Imagem fornecida pelo usuário',
                'tm_extraido_em': '17/07/2026'},
 'Guilherme Garutti': {'nome_completo': 'Guilherme Gomes Garutti',
                       'clube': 'ACSC FC Arges',
                       'idade': 32,
                       'tm_nascimento': '08/03/1994',
                       'tm_altura': '1,94 m',
                       'tm_nacionalidades': ['Brasil', 'Itália'],
                       'tm_pe': 'Direito',
                       'tm_empresario': 'FGA',
                       'tm_clube_desde': '23/07/2024',
                       'tm_contrato': '-',
                       'tm_posicao_site': 'Defesa Central',
                       'tm_posicoes_secundarias_site': [],
                       'tm_valor_mercado': '175 mil €',
                       'tm_valor_mercado_milhoes': 0.175,
                       'tm_valor_maximo': '400 mil €',
                       'tm_valor_maximo_milhoes': 0.4,
                       'tm_data_valor_maximo': '02/06/2022',
                       'tm_ultima_atualizacao': '07/06/2026',
                       'tm_fonte': 'Imagem fornecida pelo usuário',
                       'tm_extraido_em': '17/07/2026'},
 'Igor Jesus': {'nome_completo': 'Igor Jesus Maciel da Cruz',
                'clube': 'Nottingham Forest',
                'idade': 25,
                'tm_nascimento': '25/02/2001',
                'tm_naturalidade': 'Cuiabá, Brasil',
                'tm_altura': '1,79 m',
                'tm_nacionalidades': ['Brasil', 'Emirados Árabes Unidos'],
                'tm_pe': 'Direito',
                'tm_empresario': 'JBSports',
                'tm_clube_desde': '05/07/2025',
                'tm_contrato': '30/06/2029',
                'tm_posicao_site': 'Ponta de Lança',
                'tm_posicoes_secundarias_site': [],
                'tm_valor_mercado': '25,00 M. €',
                ...
                'tm_fonte': 'Imagem fornecida pelo usuário',
                'tm_extraido_em': '17/07/2026'},
 'Matheus Cunha': {'nome_completo': 'Matheus Santos Carneiro da Cunha',
                   'clube': 'Manchester United FC',
                   'idade': 27,
                   'tm_nascimento': '27/05/1999',
                   'tm_naturalidade': 'João Pessoa, Brasil',
                   'tm_altura': '1,83 m',
                   'tm_nacionalidades': ['Brasil'],
                   'tm_pe': 'Direito',
                   'tm_empresario': 'Bertolucci Sports',
